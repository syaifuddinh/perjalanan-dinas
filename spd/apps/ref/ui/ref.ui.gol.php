...
<?php 
	...
	$this->factory->Skins->Workers->container->boxOpen("Daftar Golongan","12",$closeButton=false,$colapse=false,$height="0",$color="",$icon="icon-wrench",$bt);
?>
<div class="row-fluid">
	<div class="span7">
...
<div id="popupWindow" class="row-fluid">
            ...
            <div style="overflow: hidden;">
            	...
            	<?php $this->factory->Skins->Workers->form->inputText("Golongan","","gol","span12",'data-rule-required="true"');?>
            	<?php $this->factory->Skins->Workers->form->inputText("Nama Golongan","","nama_gol","span12",'data-rule-required="true"');?>
